...
class ParentDetail extends BaseModel
{
    protected $fillable = ['created_by', 'last_updated_by', 'students_id', 'grandfather_first_name', 'grandfather_middle_name',
        ...
        'mother_mobile_1', 'mother_mobile_2', 'mother_email', 'father_image','mother_image','status','whatsapp_no','mother_whatsapp_no','father_annual_income','father_aadhar_no','mother_annual_income','mother_aadhar_no'];
