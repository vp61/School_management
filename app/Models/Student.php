...
class Student extends BaseModel{
    ...
    protected $fillable = ['created_by', 'last_updated_by', 'reg_no', 'reg_date', 'university_reg','faculty','semester',
        'academic_status', 'first_name', 'date_of_birth', 'gender', 'blood_group', 'nationality',
        'mother_tongue', 'email', 'extra_info', 'student_image','status','org_id','branch_id','category_id', 'session_id', 'zip','indose_number','passport_no','admission_id','religion_id','handicap_id','aadhar_no','course_type_id','batch_id','aadhaar_image','pass_port_image','admission_condition','place_of_birth','previous_school','previous_class','age_in_year_as_on_1april'];
   ...
   /* public function guardian()
    ...
    public function StudentSession(){
        return $this->hasMany(StudentDetailSessionwise::class, 'id', 'student_id');
    }
