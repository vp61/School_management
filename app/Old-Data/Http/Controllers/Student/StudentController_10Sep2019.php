...
class StudentController extends CollegeBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $data['student'] = Student::select('students.id', 'students.reg_no', 'students.reg_date',
            'students.faculty', 'students.semester', 'students.academic_status', 'students.first_name', 'students.middle_name', 'students.last_name', 'students.status', 'ai.mobile_1')
    ...
    $faculties = Faculty::select('id', 'faculty')
      ...
      $category= array_prepend($category,'SelectCategory',0);
        ...
        return view(parent::loadDataToView($this->view_path.'.registration.register'), compact('data','branch','category','Semester','sessions','randomString','admData','pay_type_list','courses'));
    }
 ...
 // DD();
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view(parent::loadDataToView($this->view_path.'.registration.edit'), compact('data','branches','branch'));
    }
    ...
    {   
        $qry = "SELECT sum(amount_paid) as totalPaid, max(assign_fee.fee_amount) as NeedToPay
            ...
            where collect_fee.student_id=$stdId and assign_fee.fee_head_id=$feeHeadId";
