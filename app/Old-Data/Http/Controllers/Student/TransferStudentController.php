...
class TransferStudentController extends CollegeBaseController
{
    ...
    public function index(Request $request)
    {
        $data = [];
        if($request->all()) {
            $data['student'] = StudentPromotion::select('students.id', 'students.reg_no', 'students.reg_date', 'students.first_name', 'student_detail_sessionwise.course_id as faculty', 'students.semester', 'students.status', 'student_detail_sessionwise.session_id as requested_session', 'student_detail_sessionwise.course_id', 'student_detail_sessionwise.Semester')
        ...
        $data['semester']=array_prepend($data['semester'],'--Select Semester--','');
