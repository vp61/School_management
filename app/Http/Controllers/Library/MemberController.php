...
class MemberController extends CollegeBaseController
{
    ...
    public function add(Request $request)
    {
        ...
        // $data['circulation']=DB::table('member_types')->select('id','title')->where('record_status',1)->pluck('title','id')->toArray();
        // $data['circulation']=array_prepend($data['circulation'],'--Select Member Type--','');
