...
class LabelController extends CollegeBaseController
{
    protected $base_route = 'inventory.label';
    protected $view_path = 'inventory.label';
    ...
    public function index(){
        $data['label']=Label::where('record_status',1)->select('*')->get();
