...
class UnitsController extends CollegeBaseController
{
	protected $base_route = 'inventory.units';
    protected $view_path = 'inventory.units';
    ...
    public function index(){
        $data['units']=Units::where('record_status',1)->select('*')->get();
