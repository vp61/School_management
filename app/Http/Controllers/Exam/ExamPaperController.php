...
class ExamPaperController extends CollegeBaseController
{
    protected $base_route = 'exam.setup.exam-paper';
    protected $view_path = 'exam.setup.exam-paper';
    protected $panel = 'Exam Paper Type';
