...
class HomeController extends CollegeBaseController
{
    ...
    {
        $id = auth()->user()->where('role_id',7)->first()->hook_id;
        $data = [];
        $data['guardian'] = GuardianDetail::where('id',$id)->first();

        $data['students'] = $data['guardian']->students()->get();
    ...
    {
        $this->panel = 'Notice | Guardian User';
        $data = [];
    ...
    {
        $this->panel = 'Students | Guardian User';
        $id = auth()->user()->where('role_id',7)->first()->hook_id;
        $data = [];
        $data['guardian'] = GuardianDetail::where('id',$id)->first();
    ...
    {
        $this->panel = 'Student Profile | Guardian User';
    ...
    {
        $this->panel = 'Library | Guardian User';
        $id = Crypt::decryptString($id);
        $data = [];
        $data['student_id'] = $id;
    ...
    {
        $this->panel = 'Attendance | Guardian User';
        $id = Crypt::decryptString($id);
        $data = [];
        $data['student_id'] = $id;
    ...
    {
        $this->panel = 'Hostel | Guardian User';
        $id = Crypt::decryptString($id);
    ...
    {
        $this->panel = 'Transport | Guardian User';
        $id = Crypt::decryptString($id);
        $data = [];
        $data['student_id'] = $id;
        $data['student'] = Student::select('students.id','students.reg_no', 'students.reg_date', 'students.university_reg',
    ...
    {
        $this->panel = env("course_label").' | Guardian User';
        $id = Crypt::decryptString($id);
        $data = [];
        $data['student_id'] = $id;
    ...
    {
        $this->panel = 'Download | Guardian User';
        $id = Crypt::decryptString($id);
        $data = [];
        $data['student_id'] = $id;
    ...
    {
        $this->panel = 'Exam Schedule | Guardian User';
        $id = Crypt::decryptString($id);
        $data = [];
        $data['student_id'] = $id;
        $whereCondition = [
    ...
    {
        $this->panel = 'Admit Card | Guardian User';
        $id = Crypt::decryptString($id);
        $data = [];
        $data['student_id'] = $id;
        $whereCondition = [
    ...
    {
        $this->panel = 'Exam Score | Guardian User';
        $id = Crypt::decryptString($id);
    ...
    {
        $this->panel = 'Assignment | Guardian User';
    ...
    {
        $this->panel = 'View Assignment | Guardian User';
        $id = Crypt::decryptString($id);
        if(!isset($id)) return back();
