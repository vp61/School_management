...
class StatusController extends CollegeBaseController
{
    protected $base_route = 'status';
    protected $view_path = 'academic.status';
    ...
    public function index(){
        $data['status']=Status::where('record_status',1)->select('*')->get();
