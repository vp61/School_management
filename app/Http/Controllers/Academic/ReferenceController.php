...
class ReferenceController extends CollegeBaseController
{
    protected $base_route = 'reference';
    protected $view_path = 'academic.reference';
    protected $panel = 'Reference';
    ...
    public function index(){
        $data['reference']=Reference::where('record_status',1)->select('*')->get();
