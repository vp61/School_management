...
class HandicapController extends CollegeBaseController
{
    protected $base_route = 'handicap';
    protected $view_path = 'academic.handicap';
    protected $panel = 'Handicap';
    ...
    public function index(){
        $data['handicap']=Handicap::where('record_status',1)->select('*')->get();
