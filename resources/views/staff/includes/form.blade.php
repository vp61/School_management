    ...
    <div class="tab-content">
        <div id="registrationinfo" class="tab-pane active">
            ...
            @ability('super-admin','super-admin')
                <div class="label label-warning arrowed-in arrowed-right arrowed">Live Class Credentials</div>
                <hr class="hr-8">
                <div class="form-group">
                    {!! Form::label('api_key', 'API Key', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-4">
                        {!! Form::text('zoom_api_key', null, ["class" => "form-control"]) !!}
                        
                    </div>
    
                    {!! Form::label('secret_key', 'Secret Key', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-4">
                        {!! Form::text('zoom_secret_key', null, ["class" => "form-control"]) !!}
                        
                    </div>
                </div>
    
                <div class="form-group">
                    {!! Form::label('api_key', 'Class Email', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-4">
                        {!! Form::text('zoom_email', null, ["class" => "form-control"]) !!}
                        
                    </div>
    
                    {!! Form::label('secret_key', 'Class Password', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-4">
                        {!! Form::text('zoom_password', null, ["class" => "form-control"]) !!}
                        
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('api_key', 'Class JWT', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-4">
                        {!! Form::text('zoom_jwt', null, ["class" => "form-control"]) !!}
                        
                    </div>
    
                    {!! Form::label('secret_key', 'Is Observer', ['class' => 'col-sm-2 control-label']) !!}
                    <div class="col-sm-4">
                        {!!Form::select('observer',['No'=>'No','Yes'=>'Yes'],null,["class" => "form-control"])!!}
