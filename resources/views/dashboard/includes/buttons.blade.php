...
<div class="row">
    ...
    @ability('super-admin,account','super-admin')
    <div class="col-md-2">
    ...
    @endability
    @ability('super-admin,account,library','super-admin')
    <div class="col-md-2">
    ...
    @ability('super-admin,account','super-admin')
    <div class="col-md-2">
        <a href="{{ route('exam.create') }}" class="easy-link-menu">
    ...
    @endability
    @ability('super-admin,account,transport-in-Charge','super-admin')
    <div class="col-md-2">
