...
<div class="form-horizontal" id="filterDiv">
    <div class="form-group">
        ...
        {!! Form::label('code', 'Access.No.', ['class' => 'col-sm-1 control-label']) !!}
        <div class="col-sm-2">
            {!! Form::text('code', null, ["class" => "form-control border-form","placeholder" => "Accession Number"]) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-3">
            {!! Form::text('title', null, ["class" => "form-control border-form","placeholder" => "Title"]) !!}
