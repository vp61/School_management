...
<div class="form-group">
     {!! Form::label('session', 'Online Admission Session', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
        {!! Form::select('online_admission_session',$data['session'],$data['row']->online_admission_session, ["class" => "form-control border-form", "required"]) !!}
        
    </div>
    {!! Form::label('min_pay_amount', 'Min. Admission Amount(%)', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
        {!! Form::number('online_admission_min_pay', null, ["class" => "form-control border-form", "required"]) !!}
              
    </div>
</div>
<div class="form-group">
     {!! Form::label('live_class', 'Live Class Scheduling', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
        {!! Form::select('live_class_scheduling',[''=>'--Select--','1'=>env('course_label').'  Wise','2'=>'Section Wise'],$data['row']->live_class_scheduling, ["class" => "form-control border-form", "required"]) !!}
        
    </div>
</div>
<h4 class="header large lighter blue"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Receipt Foot</h4>
<div class="form-group">
    <label class="col-sm-2 control-label">
        <i class="fa fa-print bigger-120 white" aria-hidden="true"></i> Receipt Foot
    </label>
    <div class="col-sm-10">
        {!! Form::textarea('receipt_footer', null, ["class" => "form-control border-form summernote"]) !!}
    </div>
</div>
