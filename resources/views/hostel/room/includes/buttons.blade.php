<div class="clearfix hidden-print " >
    <div class="align-left">
        ...
        <a class="{!! request()->is('hostel/*/room/*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('hostel.room.add', ['id' => $id]) }}"><i class="fa fa-plus" aria-hidden="true"></i> Manage Room</a>
        <a class="{!! request()->is('hostel/*/bed/*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('hostel.bed',['id'=>$id]) }}"><i class="fa fa-plus" aria-hidden="true"></i> Manage Bed</a>
    </div>
</div>
<hr class="hr-4">