            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable" id="reg_date">
                        <?php
                            if(isset($data['student']->reg_date) && $data['student']->reg_date!=""){
                                echo date("d-m-Y",strtotime($data['student']->reg_date));
                            }else{
                                echo " - ";
                            }
                        ?>
            ...
            <div class="profile-info-row">
                ...
                <div class="profile-info-value">
                    <span class="editable" id="student_name">
                        <?php
                            if(isset($data['student']->date_of_birth) && $data['student']->date_of_birth!=""){
                                echo date("d-m-Y",strtotime($data['student']->date_of_birth));
                            }else{
                                echo " - ";
                            }
                        ?>
