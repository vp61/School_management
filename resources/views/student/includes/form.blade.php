...
<div class="clearfix">
    <div class="form-group">
        <label class="col-sm-2 control-label">Section/Semester</label>
        <div class="col-sm-3">
...
<div class="clearfix">
    <div class="form-group">
        <label class="col-sm-2 control-label">Reg. No.</label>
         <div class="col-sm-3">
            <input type="text" name="reg_no" class="form-control" placeholder="Enter Student Reg. No." value="{{ $data['filter_query']['reg_no'] or ''}}" />
        </div>
        {!!Form::label('by','Registration By',['class'=>'col-sm-2 control-label'])!!}
        <div class="col-sm-2">
            {!!Form::select('reg_by',$data['user'],null,['class'=>'form-control'])!!}
        </div>
