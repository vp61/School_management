                            ...
                            <div class="receipt-right">
                               <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7 col-xs-7 col-md-7 nopad">
                                      {{$data[0]->faculty}} / {{$data['0']->session_name}}
                ...
                <div>
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="col-md-6">
                                    {{$feedata->fee_head_title}}<br>{{$feedata->faculty}} / {{$feedata->session_name}}
                                </td>
                        ...
                        <table class="table table-bordered">
                            <tr>
                                <td>
                                    <b>Note:-</b>
                                    <ol>
                                        <li>No other fee else than caution money will be refundable if a parent wishes to withdraw his ward anytime once the session commences.</li>
                                        <li>All fee has to be deposited between 1 to 10 quarterly or half yearly.</li>
                                        <li>Late fee will be charged owing to failure of fee deposited within due date.</li>
                                        <li>Online Fee payment confirmation is subject to the bank confirmation of the transaction.</li>
                                    </ol>
                                </td>
                            </tr>
                        </table>
