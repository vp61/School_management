...
{{@Form::open(['route'=>$base_route.'.transfer-student'])}}
<div class="clearfix">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            {!! Form::select('semester', $data['semester'],'', ['class'=>'form-control']) !!}
        </div>
        ...
        <div class="col-md-2">{!! Form::select('sesson', $ssn_list,Session::get('activeSession'), ['class'=>'form-control']) !!}</div>
    </div>
</div>
