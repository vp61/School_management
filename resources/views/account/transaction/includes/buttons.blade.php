<div class="clearfix hidden-print ">
    <div class="">
        ...
        <a class="{!! request()->is('account/transaction-head')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('account.transaction-head') }}"><i class="fa fa-group" aria-hidden="true"></i>&nbsp;Transaction Head</a>
    </div>
</div>
<hr class="hr-6">