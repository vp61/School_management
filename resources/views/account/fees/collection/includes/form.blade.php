...
<div class="clearfix">
    <div class="form-group">
        ...
        <div class="col-sm-3">
            {!! Form::text('college_id', null, ["placeholder" => "", "class" => "form-control border-form input-mask-registration", "autofocus"]) !!}
        ...
        {!! Form::label('reg_date', 'Reg. Date', ['class' => 'col-sm-6 control-label']) !!}
        <div class=" col-sm-6">
