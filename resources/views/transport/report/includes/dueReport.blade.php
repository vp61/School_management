                ...
                <div class="receipt-header">
                    <div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="receipt-left">
                            <img class="img-responsive" alt="iamgurdeeposahan" src="{{ asset('images/logo/')}}/{{$branch->branch_logo}}" style="width: 78px; border-radius: 43px;">
                        </div>
                    </div>
                    ...
                    <tbody>
                        ...
                        @foreach($data['user'] as $user)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($transport_master==1 && $user->user_type==1)
                                     -
                                    @else
                                    {{$rep[$user->id]['paid']}}
                                    @endif
