            ...
            <div>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="col-md-6">Transport</td>
                            <td class="col-md-2">{{$data[0]->total_rent}}</td>
                            <td class="col-md-2"><i class="fa fa-inr"></i> {{$data[0]->amount_paid}}</td>
                            <td class="col-md-2"> 
                                <i class="fa fa-inr"></i >
                               {{$data[0]->total_rent - $data['paid'][0]->total_paid}}
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-left text-danger"><h2 style="font-size: 15px;"><strong><i class="fa fa-inr"></i >{{$data[0]->total_rent}} /-</strong></h2></td>
                            
                            
                            <td class="text-left text-danger"><h2 style="font-size: 15px;"><strong><i class="fa fa-inr"></i >{{$data[0]->amount_paid}} /-</strong></h2></td>
                            <td class="text-left text-danger"><h2 style="font-size: 15px;"><strong><i class="fa fa-inr"></i >{{$data[0]->total_rent - $data['paid'][0]->total_paid}} /-</strong></h2></td>
                        </tr>
                        <tr> 
