...
@if(!isset($data['row']))
    <div class="form-group">
        ...
        {!! Form::label('stoppage','Stoppage',['class'=>'col-sm-2 control-label'])
        !!}
        <div class="col-sm-2">
            {!!Form::select('stoppage',[""=>"Select"],null,['class'=>'form-control', "onChange" => "loadRent(this)",'required' => 'required','id'=>'stoppage']) !!}
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            {!!Form::text('amount_paid',null,['class'=>'form-control','onkeyup'=>'addreq(this)','id'=>'amount_paid'])!!}
        </div>
        {!!Form::label('payment_mode','Payment Mode',['class'=>'col-sm-2 control-label'])!!}
        <div class="col-sm-2">
           
            {!! Form::select('pay_mode',$data['pay_type'], '', ['class'=>'form-control border-form','id'=>'pay_mode']); !!}
        </div>
