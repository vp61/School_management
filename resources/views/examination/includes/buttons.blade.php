<div class="clearfix hidden-print ">
    <div class="align-right">
        ...
        <a class="{!! request()->is('exam/mark-ledger*')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('exam.mark-ledger') }}"><i class="fa fa-share-alt" aria-hidden="true"></i>&nbsp;Mark Ledger</a>
    </div>
</div>
<hr class="hr-6">