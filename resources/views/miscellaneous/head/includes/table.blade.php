                ...
                @if (isset($data['fees_head']) && $data['fees_head']->count() > 0)
                    ...
                    @foreach($data['fees_head'] as $fees_head)
                        <tr>
                            ...
                            <td class="hidden-480 ">
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-primary btn-minier dropdown-toggle {{ $fees_head->status == '1'?"btn-info":"btn-warning" }}" >
                                        {{ $fees_head->status == '1'?"Active":"In Active" }}
