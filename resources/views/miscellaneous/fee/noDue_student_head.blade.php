...
@php 
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <form action="{{route('noDues_student')}}" method="post">
                   {{ csrf_field() }}
                    <div class="row">
                        <div class="col-sm-12">
                            @if(Session::has('msG'))
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    @if($MonthWise)
                                        ...
                                        <td style="max-width: 150px" style="max-width: 150px">{{ Form::select('due_month[]', $data['month'],null, ['class'=>'fee_type form-control selectpicker', 'data-live-search'=>'true','multiple'])}}
                                        </td>
                                    @else
                                        <td style="padding-top:10px;" ><p>Fee Type:</p></td>
                                        <td style="max-width: 150px" style="max-width: 150px">{{ Form::select('fee_type[]', $fee_list, '', ['class'=>'fee_type form-control selectpicker', 'data-live-search'=>'true','multiple'])}}
                                        </td>
                                    @endif
                                    <td>
