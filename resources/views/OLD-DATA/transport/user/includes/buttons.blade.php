<div class="clearfix hidden-print " >
    <div class="align-left">
        ...
        <a class="{!! request()->is('transport/user/add')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('transport.user.add') }}"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Assign Transport</a>
