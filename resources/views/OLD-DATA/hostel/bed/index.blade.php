                   ...
                   <div class="col-xs-12">
                    ...
                    <!-- PAGE CONTENT BEGINS -->
                        <div class="form-horizontal">
                         <div class="col-md-4">
                            @if(isset($data['row']))
                             {!! Form::open(['route' => ['hostel.bed.edit',$id,$bedId], 'method' => 'POST', 'class' => 'form-horizontal',
                                                'id' => 'validation-form', "enctype" => "multipart/form-data"]) !!}
                                @include($view_path.'.includes.edit-form')
                                {!! Form::close() !!}

                            @else
                                 {!! Form::open(['route' => ['hostel.bed.add',$id], 'method' => 'POST', 'class' => 'form-horizontal',
                                                'id' => 'validation-form', "enctype" => "multipart/form-data"]) !!}
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.error) {
                        ...
                        $('#room').html('').append('<option value>--Select Room --</option>');
                ...
                success: function (response) {
                    ...
                    if (data.error) {
                        ...
                        $.each(data.rooms, function(key,valueObj){
                            $('#room').append('<option value="'+valueObj.id+'">'+valueObj.room_number+'</option>');
                        });
                    }
                }
            });
