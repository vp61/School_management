    ...
    <div class="row">
                   <div class="col-md-12">
                        <h4 class="page-header lighter blue" style="text-align: center;">
                          <b>{{$data['hostels']->name}}</b>
                        </h4>
                   </div>
               </div>
    <form action="" method="">
        <div class="form-group">
            <input type="text" name="hostelId" value="{{$data['hostels']->id}}" hidden="hidden">
            {!! Form::label('block', 'Block', ['class' => 'col-sm-4 control-label']) !!}
            <div class="col-sm-8">
                {!! Form::select('block', $data['blocks'], null, ['class' => 'form-control' , "onChange"=>"loadFloor(this)" ,'required'=>'required','id'=>'block']) !!}
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">                 
            <label class="col-sm-4 control-label">Start Bed No</label>
            <div class="col-sm-8">
              {!!Form::text('start',null,["class"=>"form-control",'required'=>'required'])!!}  
            </div>        
        </div> 
        <div class="form-group">
             <label class="col-sm-4 control-label">End End No</label>
            <div class="col-sm-8">
              {!!Form::text('end',null,["class"=>"form-control",'required'=>'required'])!!}  
            </div>
        </div>
        <div class="form-group">
             <label class="col-sm-4 control-label">Rate Per Bed</label>
            <div class="col-sm-8">
