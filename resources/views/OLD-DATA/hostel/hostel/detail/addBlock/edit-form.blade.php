 ...
 <h4 class="header large lighter blue"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Edit Block</h4>
		 	...
		 	<div class="col-md-12">
				...
				<div class="form-group">
					 ...
					 <div class="col-sm-8">
					 	...
					 	{!!Form::text('name',$data['row']->title ,["class"=>"form-control",'required'=>'required'])!!}
				 	</div>
				</div>
