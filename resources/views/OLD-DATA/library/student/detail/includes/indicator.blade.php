...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="card card-yellow text-xs-center">
            <div class="card-block">
                <h4 class="card-title">{{ $data['student']->libBookIssue()->where('status','=',1)->count() }}</h4>
    ...
    <div class="col-md-3">
        <div class="card card-green text-xs-center">
            <div class="card-block">
                <h4 class="card-title">{{ $data['circulation']->issue_limit_books - $data['student']->libBookIssue()->where('status','=',1)->count() }}</h4>
    ...
    <div class="col-md-3">
        <div class="card card-red text-xs-center">
            <div class="card-block">
                <h4 class="card-title">{{ $data['student']->libBookIssue()->count()  }}</h4>
