<div class="clearfix hidden-print " >
    <div class="easy-link-menu align-right">
        ...
        <a class="{!! request()->is('library/return-over')?'btn-success':'btn-danger' !!} btn-sm " href="{{ route('library.return-over') }}"><i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp;  Return Period Over&nbsp;</a>
    </div>
</div>
<hr class="hr-6">