...
<td>@ability('super-admin','super-admin')
    <a href="/edit/fee_collection/{{$x->id}}"><i class="fa fa-pencil"></i></a>
    <a href="/delete/fee_collection/{{$x->id}}" class="tooltip-error red deleteConfirm" data-rel="tooltip" title="Delete" id="delete"><i class="fa fa-trash" ></i></a>
 @endability
 <a target="_blank" href="studentfeeReceipt/{{$x->reciept_no}}"><i class="fa fa-print"></i></a>  
</td>
                            </tr>
                           @endforeach
