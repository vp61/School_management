                ...
                <tr>
                    ...
                    <td>
                        <div class="hidden-sm hidden-xs action-buttons">
                            @if(isset($approveStatus))
                                <a href="{{ route('user-guardian.students.assignment.answer.view', ['id'=>Crypt::encryptString($data['student_id']),'assignment' => $assignment->id, 'answer'=> $approveStatus->id]) }}" class="btn btn-primary btn-minier btn-primary">
