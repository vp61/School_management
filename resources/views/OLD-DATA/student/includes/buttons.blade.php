<div class="clearfix hidden-print ">
    <div class="easy-link-menu align-left">
        ...
        <a class="{!! request()->is('student/transfer')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('student.transfer') }}"><i class="fa fa-exchange" aria-hidden="true"></i>&nbsp;Promote</a>
        ...
        <a class="{!! request()->is('student/transfer-student')?'btn-success':'btn-primary' !!} btn-sm" href="{{ route('student.transfer-student') }}"><i class="fa fa-exchange" aria-hidden="true"></i>&nbsp;Transfer</a>
    </div>
    <hr class="hr-6 ">
</div>
