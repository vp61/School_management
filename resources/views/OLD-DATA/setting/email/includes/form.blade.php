...
<div class="form-group">
    {!! Form::label('driver', 'Driver', ['placeholder'=>'e.g.SMTP','class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
        {!! Form::text('driver', null, ["class" => "form-control border-form", "required", "autofocus"]) !!}
        @include('includes.form_fields_validation_message', ['name' => 'driver'])
    </div>

    {!! Form::label('host', 'Host', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
        {!! Form::text('host', null, ["class" => "form-control border-form", "required"]) !!}
        @include('includes.form_fields_validation_message', ['name' => 'host'])
    </div>
</div>

<div class="form-group">
    {!! Form::label('port', 'Driver', ['placeholder'=>'e.g.SMTP','class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
        {!! Form::text('port', null, ["class" => "form-control border-form", "required"]) !!}
        @include('includes.form_fields_validation_message', ['name' => 'port'])
    </div>

    {!! Form::label('encryption', 'Encryption', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-4">
        {!! Form::text('encryption', null, ["class" => "form-control border-form", "required"]) !!}
