				...
				<div class="row no-gutters" >
					<div class="col-sm-12" >
						@if($comment->member_type==2)
							<p style="border-bottom: 1px solid;margin-right:30%;padding: 1%; font-weight: 600;border-radius: 4px 4px;overflow-wrap: break-word;overflow: hidden;" class="bg-info bg-minier">{{$comment->comment}}<i class="pull-right">Staff->{{$comment->member_name}} : {{$comment->created_at}}</i></p>
						@endif	
