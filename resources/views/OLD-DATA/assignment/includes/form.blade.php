...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <div class="col-sm-3">
                {!! Form::select('semesters_id', $data['semesters'], null, ['class' => 'form-control semesters_id', 'onChange' => 'loadSubject(this);']) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                {!! Form::select('subjects_id', $data['subjects'], null, ['class' => 'form-control semester_subject']) !!}
