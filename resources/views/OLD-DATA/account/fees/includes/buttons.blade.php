<div class="clearfix hidden-print ">
    <div class="easy-link-menu">
        ...
        <a class="{!! request()->is('account/fees/balance')?'btn-success':'btn-warning' !!} btn-sm" href="{{ route('account.fees.balance') }}"><i class="fa fa-money" aria-hidden="true"></i>&nbsp;Due Fees</a>
