                ...
                <tr>
                    ...
                    <td>
                        <div class="hidden-sm hidden-xs action-buttons">
                            @if(!isset($approveStatus))
                                <a href="{{ route('user-student.assignment.answer.add', ['id' => $assignment->id]) }}" class="btn btn-primary btn-minier btn-primary">
                            ...
                            @if(isset($approveStatus))
                                    @if( $approveStatus->approve_status != 1)
                                    <a href="{{ route('user-student.assignment.answer.edit', ['id' => $assignment->id]) }}" class="btn btn-primary btn-minier btn-success">
                                        <i class="ace-icon fa fa-pencil bigger-130"></i> Edit
                                    </a>
                                    @endif
                                <a href="{{ route('user-student.assignment.answer.view', ['id' => $assignment->id, 'answer'=> $approveStatus->id]) }}" class="btn btn-primary btn-minier btn-primary">
