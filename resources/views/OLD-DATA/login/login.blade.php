            ...
            <div class="col-sm-10 col-sm-offset-1">
                <div class="login-container">
                    <div class="center" style="margin-top: 10%;">
                        <h1 style="font-size: 27px;color: #f5931c;">
                            <img src="{{asset('images/logo/ashamain.png')}}" style="width: 183px;"><br>
                            <span class="" id="id-text2" >ASHA EDUCATIONAL SOCIETY</span>
                        </h1>
                    ...
                    <div class="position-relative">
                        <div id="login-box" class="login-box visible widget-box no-border" style="box-shadow: 2px 6px 6px lightgrey;">
