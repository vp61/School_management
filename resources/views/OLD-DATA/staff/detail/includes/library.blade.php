<div class="row">
    ...
    <div class="col-xs-12">
        ...
        <div class="clearfix easy-link-menu">
            <span>
                <a class="btn-primary btn-sm" href="{{ route('library.staff.view', ['id' => $data['lib_member']->id]) }}">
        ...
        @else
        <h4 class="large lighter blue">
            <i class="fa fa-book" aria-hidden="true"></i>&nbsp;Not a Valid Library Member.
        </h4>
    @endif
