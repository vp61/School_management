                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    @if(Session::get('isCourseBatch'))
                                        <td style="padding-top:8px;">{{ env('course_label') }}:</td>
                                        ...
                                        <td style="padding-top:8px;">Batch:</td>
                                        <td >
                                    ...
                                    @else
                                        ...
                                        <td style="padding-top:8px;">Section:</td>
                                        <td>{{ Form::select('semester', $semester_list, '', ['class'=>'form-control semester','id'=>'semester_select']) }}</td>
                                    @endif

                                    
                                    @if($MonthWise)
                                        <td style="padding-top:8px;" ><p>Due Month:</p></td>
                                        <td style="max-width: 80px" class="searchDropdownWidth">{{ Form::select('due_month[]', $data['month'],null, ['class'=>'fee_type form-control selectpicker', 'data-live-search'=>'true','multiple','style'=>'max-width:100px'])}}
                                        </td>
                                    @else
                                        <td style="padding-top:5px;" ><p>Fee Type:</p></td>
                                        <td style="max-width: 80px" class="searchDropdownWidth">{{ Form::select('fee_type[]', $fee_list, '', ['class'=>'fee_type form-control selectpicker', 'data-live-search'=>'true','multiple','style'=>'max-width:100px'])}}
                                        </td>
                                    @endif
                                ...
                                <tr>
                                    <td style="padding-top:7px;" ><p>Student:</p></td>
