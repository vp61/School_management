            ...
            <div class="row">
                <div class="receipt-header receipt-header-mid">
                    <div class="col-xs-12 col-sm-12 col-md-12" style="padding-bottom: 3px;text-align: center;">
                        <h4 text-align="center">Student Due Report (Overall) <button class="pull-right btn btn-success hidden-print" onclick="Export('Overall-DueReport')"> Export</button></h4>
                        {{-- - {{$info['courseName']}} --}}
                    </div> 
                                ...
                                @if($key==$k)
                                    ...
                                    @if($show)
                                     <tr>
                                        ...
                                        <td nowrap>{{$val[0]->reg_no}}</td>
                                        <td nowrap>{{$val[0]->course_name}}</td>
                                        <td>{{$val[0]->semester}}</td>
                                        <td nowrap> {{$collect[$key]['total']}}</td>    
                                        <td nowrap> {{$collect[$key]['paid']}}</td>
                                        <td nowrap> {{$collect[$key]['discount']}}</td>
                                        <td nowrap> {{$collect[$key]['due']}}</td>
                                    </tr>
                                    @php 
