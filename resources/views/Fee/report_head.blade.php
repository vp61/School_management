    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                ...
                <form action="{{route('report_head')}}" method="post">
                   {{ csrf_field() }}
                    <div class="row">
                       <div class="col-sm-12">
                            @if(Session::has('msG'))
                    ...
                    <div class="receipt-main col-xs-10 col-sm-10 col-md-10 col-xs-offset-1 col-sm-offset-1 col-md-offset-1">
                        <div class="row">
                            <div class="receipt-header">
                                <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                                    <h4>The Aryan International School</h4>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="receipt-header receipt-header-mid">
                            <div class="col-xs-12 col-sm-12 col-md-12" style="padding-bottom: 3px;text-align: center;">
                                <h4 text-align="center">Report head <button class="pull-right btn btn-info hidden-print" onclick="window.print()"> <i class="fa fa-print"></i> Print</button></h4>
                            </div> 
                        ...
                        <div class="col-xs-12" style="padding: 0px">
                            <form method="POST" action="{{ route('report_head') }}">
                                {{ csrf_field() }}
                                        ...
                                        @if(count($master)>0  && count($master)>0)
                                            ...
                                            @foreach($master as $key => $value)
                                                ...
                                                @endphp                                           
                                                    ...
                                                    @endforeach
                                               <tr class="bg-danger">
                                                    <td colspan="3">  <b>{{$va['month']}}'s</b>  <b>Total</b></td>
                                                    <td>&#8377; {{$ttl}}</td>
                                                    <td>&#8377; {{$paid}}</td>
                                                    <td>&#8377; {{$sum}}</td>
