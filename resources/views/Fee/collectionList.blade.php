        ...
        <div class="form-group">
            ...
            <div class=" col-sm-5">
                <div class="input-group ">
                    {!! Form::date('reg_start_date', null, ["placeholder" => "YYYY-MM-DD", "class" => "input-sm form-control border-form input-mask-date date-picker", "data-date-format" => "yyyy-mm-dd", "required" => "required"]) !!}
                    <span class="input-group-addon">
                        <i class="fa fa-exchange"></i>
                    </span>
                    {!! Form::date('reg_end_date', null, ["placeholder" => "YYYY-MM-DD", "class" => "input-sm form-control border-form input-mask-date date-picker", "data-date-format" => "yyyy-mm-dd", "required" => "required"]) !!}
...
<div class="clearfix">  
    <div class="form-group">
        <label class="col-sm-2 control-label">Assign Session</label>
        <div class="col-sm-3">
            {!! Form::select('session_id', $session_list, null, ['class' => 'form-control']) !!}
        </div>
    </div>
</div>
<div class="clearfix">
        ...
        @include('includes.data_table_header')
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover" style="font-size: 11px !important">
                ...
                <td>@if($x->reciept_date) {{ Carbon\Carbon::parse($x->reciept_date)->format('d-M-Y') }} @endif</td>
                                <td>{{$x->reference}}</td>
<td >
        @ability('super-admin','super-admin,edit-fees-collection')
            <a href="/edit/fee_collection/{{$x->reciept_no}}" title="Edit" class="tooltip-error btn btn-minier" data-rel="tooltip"><i class="fa fa-pencil"></i></a>
        @endability
@ability('super-admin','super-admin,fees-delete-collection')        
    <a href="/delete/fee_collection/{{$x->reciept_no}}" class="tooltip-error red deleteConfirm btn btn-minier btn-danger" data-rel="tooltip" title="Delete" id="delete"><i class="fa fa-trash" ></i></a>
 @endability
 @ability('super-admin','account,cancel-receipt')
 <a href="/cancel/fee_receipt/{{$x->reciept_no}}" class="tooltip-error green cancelConfirm btn btn-minier btn-warning" data-rel="tooltip" title="Cancel" id="cancel"><i class="fa fa-times" aria-hidden="true"></i></a>
 @endability
