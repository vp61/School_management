<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;Macro Planner List</h4>
        <div class="clearfix">
                    ...
                    @foreach($data['Lesson_plans'] as $Lesson_plans)
                        ...
                        <tr>
                            ...
                            <td>
                             ...
                             <td>Term-{{$Lesson_plans->term}}</td>
                            <td>
                                <a href="{{ asset('Macro_planner'.DIRECTORY_SEPARATOR.$Lesson_plans->file) }}" target="_blank">
                                           {{ $Lesson_plans->file }}
                                </a>
                            </td>
                            <td>
