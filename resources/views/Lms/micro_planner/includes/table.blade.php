<div class="row">
    <div class="col-xs-12">
        <h4 class="header large lighter blue"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;Micro Planner List</h4>
        <div class="clearfix">
    ...
    <span class="easy-link-menu">
        ...
        <div class="table-responsive">
            ...
            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                ...
                <tbody>  
                @if (isset($data['Micro_planner']) && $data['Micro_planner']->count() > 0)
                    @php($i=1)
                    @foreach($data['Micro_planner'] as $Lesson_plans)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ asset('Micro_planner'.DIRECTORY_SEPARATOR.$Lesson_plans->file) }}" target="_blank">
                                           {{ $Lesson_plans->file }}
                                </a>
                            </td>
                            <td>
