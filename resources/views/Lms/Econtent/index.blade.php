                ...
                if (data.error) {
                    ...
                    $.each(data.topic, function(key,valueObj){
                        ...
                        $('#data').append("<tr><td>"+
                            "<td>"+ (i++) +
                            "<td>"+ valueObj.topic +
                            "<td>"+'<a href="/Econtent/'+valueObj.file +'">'+valueObj.file+'</a>'+
                            "<td>"+valueObj.detail+
                            "<td>"+'<a href="Econtent/'+valueObj.id +'/edit" class="btn btn-primary btn-minier btn-success"><i class="ace-icon fa fa-pencil bigger-130"></i></a>'+' &nbsp; '+'<a href="Econtent/'+valueObj.id+'/delete" class="btn btn-primary btn-minier btn-success"><i class="ace-icon fa fa-trash-o bigger-130"></i></a>'+
                            "<td></tr>");
                    }); 
                }   
            }
