                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <!-- assign subject to teacher -->
                                     <?Php
                                        $arr=[];
                                        //dd($data['assigned_sub']);
                                       foreach ($data['assigned_sub'] as $key => $value) {
                                           $arr[]=$value->timetable_subject_id;
                                       }
                                           
                                     ?>
                                    {!!Form::select('subject[]',$data['subject'],$arr,['class'=>'form-control selectpicker','required'=>'required','data-live-search'=>'true','multiple'=>'multiple'])!!}
                                     <!-- assign subject to teacher -->
                                </div>
